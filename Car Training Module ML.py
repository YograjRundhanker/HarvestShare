...
red_small_car = pygame.image.load('Images/Sprites/red_small.png')
red_big_car = pygame.image.load('Images/Sprites/red_big.png')
blue_small_car = pygame.image.load('Images/Sprites/blue_small.png')
blue_big_car = pygame.image.load('Images/Sprites/blue_big.png')


bg = pygame.image.load('trial2.png')
bg4 = pygame.image.load('trial.png')
        ...
        if event.type == pygame.KEYDOWN: #If user uses the keyboard
            ...
            if event.key == ord ( "b" ):
                if (len(selectedCars) == 2):
                    ...
                    nnCars[num_of_nnCars-2].car_image = blue_small_car
                    nnCars[num_of_nnCars-1].car_image = blue_small_car
                ...
                for nncar in nnCars:  
                    ...
                    if (polygon.contains(point)):
                        if nncar in selectedCars:
                            ...
                            selected -= 1
                            if nncar.car_image == red_big_car:
                                nncar.car_image = red_small_car 
                            ...
                            if len(selectedCars) < 2:
                                ...
                                selected +=1
                                if nncar.car_image == red_small_car:
                                    nncar.car_image = red_big_car  
